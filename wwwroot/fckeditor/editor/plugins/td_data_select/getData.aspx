<%@ Page Language="C#" AutoEventWireup="true" CodeFile="getData.aspx.cs" Inherits="fckeditor_editor_plugins_td_data_select_getData" %>
...
-<input type="text" name="itemTitle" id="Text1" size=10> <input type="checkbox" name="isQuery" id="Checkbox1" title="是否作为查询字段"><label for="isQuery">查</label>
<a href="javascript:;" class="orgAdd" onclick="add();">添加</a>
<%}
...
-<input type="text" name="itemTitle" id="Text2" size=10> <input type="checkbox" name="isQuery" id="Checkbox2" title="是否作为查询字段"><label for="isQuery">查</label>
<a href="javascript:;" class="orgAdd" onclick="add();">添加</a>
<%}
...
-<input type="text" name="itemTitle" id="Text3" size=10> <input type="checkbox" name="isQuery" id="Checkbox3" title="是否作为查询字段"><label for="isQuery">查</label>
<a href="javascript:;" class="orgAdd" onclick="add();">添加</a>
<%}
...
-<input type="text" name="itemTitle" id="Text4" size=10> <input type="checkbox" name="isQuery" id="Checkbox4" title="是否作为查询字段"><label for="isQuery">查</label>
<a href="javascript:;" class="orgAdd" onclick="add();">添加</a>
<%}
...
-<input type="text" name="itemTitle" id="Text5" size=10> <input type="checkbox" name="isQuery" id="Checkbox5" title="是否作为查询字段"><label for="isQuery">查</label>
<a href="javascript:;" class="orgAdd" onclick="add();">添加</a>
<%}
...
-<input type="text" name="itemTitle" id="Text6" size=10> <input type="checkbox" name="isQuery" id="Checkbox6" title="是否作为查询字段"><label for="isQuery">查</label>
<a href="javascript:;" class="orgAdd" onclick="add();">添加</a>
<%}%>