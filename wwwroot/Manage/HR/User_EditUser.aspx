<%@ Page Title="" Language="C#" MasterPageFile="~/Manage/Master/MasterPage2.Master" AutoEventWireup="true" CodeBehind="User_EditUser.aspx.cs" Inherits="wwwroot.Manage.HR.User_EditUser" ClientIDMode="Static" EnableEventValidation="false" %>
...
<uc1:MenuBar ID="MenuBar1" runat="server" Key="user-detail" CurIndex="2" Param1="{Q:UserID}" />
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder" runat="server">
    <div id="PanelManage">
        ...
        <caption style="text-align:left; font-style:normal;">用户重要信息</caption>
            <%--<tr>
                ...
                <td>
                    ...
                    <asp:DropDownList ID="ddlCompany" runat="server" CssClass="easyui-combobox"
                        panelHeight="auto">
                    </asp:DropDownList>
                    &nbsp;
                </td>
            ...
            <tr>
                ...
                <td>
                    ...
                    <asp:DropDownList ID="ddlPosition" runat="server" CssClass="easyui-combobox" panelHeight="auto"
                        required="true" Height="17px" Width="100px">
                    </asp:DropDownList>
                    &nbsp;
                </td>
            </tr>--%>
            ...
            <tr>
                ...
                <td>
                    ...
                    <asp:TextBox ID="txtIDCard" runat="server" Columns="30" MaxLength="90" class="easyui-validatebox"
                        validType="idcard" required="true" invalidMessage="请输入有效的身份证号码！"></asp:TextBox> &nbsp;<asp:FileUpload ID="FileUpload2" runat="server" />
        ...
        <table class="table">
             ...
             <tr>
                ...
                <td>
                  ...
                  <asp:TextBox Width="162" ID="ui_Titles" runat="server" MaxLength="20"
                        validType="phone"></asp:TextBox>  
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>民族</b>&nbsp;&nbsp; <asp:TextBox Width="162" ID="ui_Ethnic" runat="server" MaxLength="20"  required="true"></asp:TextBox>                
                </td>
            </tr>
             <tr>
                <th style="width: 135px; font-weight: bold;">
                ...
                <td>
                    ...
                    </asp:DropDownList><b style="padding-left:116px;">专业</b>&nbsp;&nbsp;<asp:TextBox Width="162" ID="ui_Prof" runat="server" MaxLength="20" required="true"></asp:TextBox>
                </td>
            </tr>
             <tr>
                <th style="width: 135px; font-weight: bold;">
            ...
            <tr>
                ...
                <td>
                    ...
                    <asp:TextBox ID="txtAddress" runat="server" MaxLength="30" Columns="60" CssClass="easyui-validatebox"
                        required="true"></asp:TextBox>&nbsp;&nbsp;<b>邮编</b>&nbsp;&nbsp;<asp:TextBox Width="80" ID="txtaddresscode" runat="server" MaxLength="20" ></asp:TextBox>
                    &nbsp;
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <th style="width: 135px; font-weight: bold;">
                    保险情况&nbsp;<a href="#" class="help">[?]</a>
                </th>
                <td>
                    <span class="note">是否有保险。</span>
