<%@ Page Title="" Language="C#" MasterPageFile="~/Manage/Master/MasterPage2.Master" AutoEventWireup="true" CodeBehind="User_Work.aspx.cs" Inherits="wwwroot.Manage.HR.User_Work" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="text" runat="server">
    <uc1:MenuBar ID="MenuBar1" runat="server" Key="user-detail" CurIndex="5" Param1="{Q:UserID}" />
</asp:Content>
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder" runat="server">
    <div id="PanelManage">       <table class="table" runat="server" id="t3">
            <tr>
                <td>
                    <center>
                        <iframe height="400" frameborder="0" width="90%" src="../include/KeyXmlEdit.aspx?table=TU_Employees&column=Work&appid=Priv-Work&key=UserID&keyvalue=<%=WX.Request.rUserId %>">
                        </iframe>
                    </center>
                </td>
            </tr>
