<%@ Page Title="" Language="C#" MasterPageFile="~/Manage/Master/MasterPage2.Master"
    ClientIDMode="Static" AutoEventWireup="true" CodeBehind="User_Credentials.aspx.cs"
    Inherits="wwwroot.Manage.HR.User_Credentials" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="text" runat="server">
    <uc1:MenuBar ID="MenuBar1" runat="server" Key="user-detail" CurIndex="8" Param1="{Q:UserID}" />
</asp:Content>
            ...
            <tr>
                <td colspan="2" align="center" style="padding:10px 10px 10px 10px;">
                    <asp:DataList ID="DataList1" BackColor="White" runat="server" Width="100%" OnItemCommand="DataList1_ItemCommand"
                        RepeatColumns="4">
                        <ItemTemplate>
                                        <a href="javascript:PopupIFrame('User_CredentialsDetail.aspx?Id=<%# Eval("Id") %>','查看详细','','',900,800)"><img src="<%# Eval("Annex") %>" alt="<%# Eval("Content") %>" width="220" height="150" /></a>
                                  <br />
                                        <b><%# Eval("Name") %></b>&nbsp;[
