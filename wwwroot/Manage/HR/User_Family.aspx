<%@ Page Title="" Language="C#" MasterPageFile="~/Manage/Master/MasterPage2.Master" AutoEventWireup="true" CodeBehind="User_Family.aspx.cs" Inherits="wwwroot.Manage.HR.User_Family" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="text" runat="server">
    <uc1:MenuBar ID="MenuBar1" runat="server" Key="user-detail" CurIndex="6" Param1="{Q:UserID}" />
</asp:Content>
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder" runat="server">
    ...
    <table class="table" runat="server" id="t3">
            <tr>
                <td>
                    <center>
                        <iframe height="400" frameborder="0" width="90%" src="../include/KeyXmlEdit.aspx?table=TU_Employees&column=Family&appid=Priv-Family&key=UserID&keyvalue=<%=WX.Request.rUserId %>">
                        </iframe>
                    </center>
                </td>
            </tr>
