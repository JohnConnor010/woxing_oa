...
namespace wwwroot.Manage.HR
{
    public partial class User_UrgentLink : System.Web.UI.Page
    {
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            if (iR > 0)
            {
                WX.Main.AddLog(WX.LogType.Default, "员工紧急联络人修改成功！", "");
            }
            //7.返回处理结果或返回其它页面。
            if (iR > 0)
            {
                ULCode.Debug.Confirm(this, "员工紧急联络人修改成功！是否返回员工列表页？", "User_UserList.aspx?CompanyID=11", this.Request.RawUrl);
            }
            else
            {
                ULCode.Debug.Alert(Page, "员工紧急联络人修改成功！");
            }
        }
