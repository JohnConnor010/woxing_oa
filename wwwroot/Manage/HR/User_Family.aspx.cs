...
{
    public partial class User_Family : System.Web.UI.Page
    {
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            if (iR > 0)
            {
                ULCode.Debug.Confirm(this, "员工家庭成员修改成功！是否返回员工列表页？", "User_UserList.aspx?CompanyID=11", this.Request.RawUrl);
            }
            else
            {
                ULCode.Debug.Alert(Page, "员工家庭成员修改成功！");
            }
        }
