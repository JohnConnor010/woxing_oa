<%@ Page Title="" Language="C#" MasterPageFile="~/Manage/Master/MasterPage2.Master"
    AutoEventWireup="true" CodeBehind="User_Education.aspx.cs" Inherits="wwwroot.Manage.HR.User_Education" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="text" runat="server">
    <uc1:MenuBar ID="MenuBar1" runat="server" Key="user-detail" CurIndex="4" Param1="{Q:UserID}" />
</asp:Content>
    ...
    <div id="PanelManage">
        <table class="table" runat="server" id="t3">
            <tr>
                <td>
                    <center>
                        <iframe height="400" frameborder="0" width="90%" src="../include/KeyXmlEdit.aspx?table=TU_Employees&column=Education&appid=Priv-Edu&key=UserID&keyvalue=<%=WX.Request.rUserId %>">
                        </iframe>
                    </center>
                </td>
            </tr>
