<%@ Page Title="" Language="C#" MasterPageFile="~/Manage/Master/MasterPage2.Master" AutoEventWireup="true" CodeBehind="Ass_AddDestroy.aspx.cs" Inherits="wwwroot.Manage.Assets.Ass_AddDestroy" ClientIDMode="Static" %>
...
<uc1:MenuBar ID="MenuBar1" runat="server" Key="Assets" CurIndex="4" />
</asp:Content>
            ...
            <tr>
                ...
                <td>
                    ...
                    <asp:Button ID="btnSave" runat="server" CssClass="button" 
                         Text="确定归还" onclick="btnSave_Click" />
