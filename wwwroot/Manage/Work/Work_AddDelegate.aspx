<%@ Page Title="" Language="C#" MasterPageFile="~/Manage/Master/MasterPage2.Master"
    AutoEventWireup="true" CodeBehind="Work_AddDelegate.aspx.cs" Inherits="wwwroot.Manage.Work.Work_AddDelegate" ClientIDMode="Static" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="text" runat="server">
    <uc1:MenuBar ID="MenuBar1" runat="server" Key="work_delegate" CurIndex="1" />
</asp:Content>
...
&nbsp;
            ...
            <tr>
                ...
                <td>
                    &nbsp;
                    <asp:Button ID="btnSave" runat="server" CssClass="button" Text="添加" 
