<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WorkOrder_My_Show.aspx.cs"
    Inherits="wwwroot.Manage.WorkOrder.WorkOrder_My_Show" %>
...
<body>
    ...
    <div style="width: 850px; height: 540px; overflow-y: auto; overflow-x: hidden; padding-left: 5px;">
        ...
        <div style="width: 815px; height: 55px; border: 1px solid #aaa; padding: 10px;">
            <table height="55" width="100%">
                <tr>
                    ...
                    <td colspan="2">
                       <asp:Literal ID="State_my" runat="server"></asp:Literal>&nbsp;&nbsp;<asp:Button
                            ID="Button2" runat="server" Text="接收" OnClientClick="return window.confirm('操作后不可恢复，确定接收吗？')" OnClick="Button2_Click1" Visible="false" />&nbsp;&nbsp;<asp:Button
                                ID="Button3" runat="server" Text="执行" OnClick="Button2_Click2" Visible="false" OnClientClick="return window.confirm('确定执行吗？')" />&nbsp;&nbsp;<asp:Button
                                    ID="Button4" runat="server" Text="暂停" OnClick="Button2_Click3" Visible="false" OnClientClick="return window.confirm('确定暂停吗？')" />&nbsp;&nbsp;<asp:Button
                                        ID="Button5" runat="server" Text="提交验收" OnClick="Button2_Click4" OnClientClick="return window.confirm('操作后不可恢复，确定提交验收吗？')" Visible="false" />
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <asp:Literal ID="StopTime_my" runat="server"></asp:Literal>
                    </td>
                    <td style="text-align: right; color: #999;">
        ...
        <div style="width: 815px; height: 5px;">
        </div>
        <table>
            <tr>
                <td id="mess" runat="server" visible="false" style="width: 815px;">
                    ...
                    <fieldset style="background-color: #eee; <%=(state==6||state==8)?"height": " max-height"%>:240px;
                                        ...
                                        <td style="padding: 5px; padding-left: 5px; padding-right: 5px;">
                                            <div style="<%# Eval("ToUserID").ToString()==WX.Main.CurUser.UserID?"color:Blue !important;": (Eval("FromUserID").ToString()==WX.Main.CurUser.UserID?"color:Green !important;":"")%>">
                                                ...
                                                <%#Eval("AddTime")%>&nbsp;&nbsp;<asp:LinkButton ID="LinkButton1" CommandArgument='<%#Eval("FromUserID")%>'
                                                    Visible='<%#Eval("FromUserID").ToString()==WX.Main.CurUser.UserID || Eval("FromUserID").ToString()=="" || Eval("State")=="6"||Eval("State")=="8"?false:true %>'
