<%@ Page Title="" Language="C#" MasterPageFile="~/Manage/Master/MasterPage2.Master" AutoEventWireup="true" CodeBehind="WorkOrder_Assign.aspx.cs" Inherits="wwwroot.Manage.WorkOrder.WorkOrder_Assign" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ScriptPlaceHolder" runat="server">
    ...
    <style type="text/css">
.pstyle{ background-color:#CFD6DD;}
...
<asp:Content ID="Content3" ContentPlaceHolderID="text" runat="server">
    <uc1:MenuBar ID="MenuBar1" runat="server" Key="WorkOrder_Assign" CurIndex="1" />
</asp:Content>
