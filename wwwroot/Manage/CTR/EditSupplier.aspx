<%@ Page Title="" Language="C#" MasterPageFile="~/Manage/Master/MasterPage2.Master" AutoEventWireup="true" CodeBehind="EditSupplier.aspx.cs" Inherits="wwwroot.Manage.CTR.EditSupplier" %>
...
&nbsp;</td>
            ...
            <tr>
                ...
                <td>
                    <asp:Button ID="btnSave" runat="server" CssClass="button" Text="确定修改"  OnClientClick="return Validator.Validate(this.form,3);" 
