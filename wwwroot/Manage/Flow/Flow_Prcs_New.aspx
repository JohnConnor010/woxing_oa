<%@ Page Title="" Language="C#" MasterPageFile="~/Manage/Master/MasterPage2.Master" AutoEventWireup="true" CodeBehind="Flow_Prcs_New.aspx.cs" Inherits="wwwroot.Manage.Flow.Flow_Prcs_New" %>
...
<uc1:MenuBar ID="MenuBar1" runat="server" Key="flow-modi" CurIndex="7" Param1="{Q:Id}" />
</asp:Content>
            ...
            <tr>
                <td colspan="4">
                    <div style="text-align: center; width: 98%;">
                        <asp:Button ID="btnSubmit" runat="server" CssClass="button" Text=" 提交 " OnClick="btnSubmit_Click" /></div>
                </td>
                <td>
                </td>
            </tr>
