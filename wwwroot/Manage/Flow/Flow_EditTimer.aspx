<%@ Page Title="" Language="C#" MasterPageFile="~/Manage/Master/MasterPage2.Master" AutoEventWireup="true" CodeBehind="Flow_EditTimer.aspx.cs" Inherits="wwwroot.Manage.Flow.Flow_EditTimer" ClientIDMode="Static" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ScriptPlaceHolder" runat="server">
    ...
    <script type="text/javascript">
        $(function () {
            var selectValue = $('#ddlRemindType').val();
            switch (selectValue) {
                case "1":
                    $('#tr0').show();
                    $('#tr1').hide();
            ...
            <tr>
                ...
                <td>
                    <asp:DropDownList ID="ddlRemindType" runat="server">
                        <asp:ListItem Value="0">只运行一次</asp:ListItem>
                        <asp:ListItem Selected="True" Value="1">按日发起</asp:ListItem>
                        <asp:ListItem Value="2">按周发起</asp:ListItem>
                        <asp:ListItem Value="3">按月发起</asp:ListItem>
                        <asp:ListItem Value="4">按年发起</asp:ListItem>
                    </asp:DropDownList>
&nbsp;
                </td>
            </tr>
            <tr id="tr0" style="display:none">
                ...
                <td><asp:TextBox  class="easyui-datetimebox" ID="txtTimer1" runat="server" data-options="required:true,showSeconds:false" style="width:150px"></asp:TextBox>
                </td>
            </tr>
            <tr id="tr1">
                <th style="width: 140px; font-weight: bold;">
...
&nbsp;<asp:DropDownList ID="ddlDay" runat="server">
            ...
            <tr>
                ...
                <td>
                    &nbsp;
                    <asp:Button ID="btnSubmit" runat="server" CssClass="button" Text="确定修改 " 
