<%@ Page Title="" Language="C#" MasterPageFile="~/Manage/Master/MasterPage2.Master" AutoEventWireup="true" CodeBehind="Flow_AddRole.aspx.cs" Inherits="wwwroot.Manage.Flow.Flow_AddRole" ClientIDMode="Static" %>
...
<script type="text/javascript">
    $(function () {
        ...
        $('#form1').submit(function () {
            /*if ($('#hidden_UserList').val() == "") {
                alert("请选择授权范围(人员)！");
                return false;
            }
            if ($('#hidden_DepartmentList').val() == "") {
                alert("请选择授权范围(部门)！");
                return false;
            }
            if ($('#hidden_RoleList').val() == "") {
                alert("请选择授权范围(角色)！");
                return false;
            }*/
        });
...
&nbsp;╋<a href="javascript:void(0)" onclick="PopupIFrame('/App_Ctrl/SelectRoles.aspx?CompanyId=11','选择角色','hidden_RoleList','txtRoleList',430,230);">选择</a></td>
            ...
            <tr class="">
                ...
                <td>
                    ...
                    <div id="custom_dept" style="display:none">
