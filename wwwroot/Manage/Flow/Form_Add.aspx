<%@ Page Title="" Language="C#" MasterPageFile="~/Manage/Master/MasterPage2.Master" AutoEventWireup="true" CodeBehind="Form_Add.aspx.cs" Inherits="wwwroot.Manage.Flow.Form_Add" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="text" runat="server">
    <uc1:MenuBar ID="MenuBar1" runat="server" Key="form" CurIndex="2" />
</asp:Content>
    ...
    <div id="PanelManage">
        <table class="table">
            <thead>
                <tr>
                    <td colspan="2">
                        你正在添加一个表单&nbsp;<a href="#" title='查看所有帮助' class="helpall">[?]</a> &nbsp;
