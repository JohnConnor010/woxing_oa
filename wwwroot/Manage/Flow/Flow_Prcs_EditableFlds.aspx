<%@ Page Title="" Language="C#" MasterPageFile="~/Manage/Master/MasterPage2.Master" ClientIDMode="Static" AutoEventWireup="true" CodeBehind="Flow_Prcs_EditableFlds.aspx.cs" Inherits="wwwroot.Manage.Flow.Flow_Prcs_EditableFlds" %>
...
<uc1:MenuBar ID="MenuBar1" runat="server" Key="flow-prcs-modi" CurIndex="6" Param1="{Q:FlowId}" Param2="{Q:Id}" />
</asp:Content>
    ...
    <div style="padding-left:10px;">
        <table class="TableTop" width="500" align="center">
            <tr>
                ...
                <td class="center">
                    <img src="/images/edit.gif" width="22" height="20" align="absmiddle" /><span class="big3">编辑可写字段
                        - 步骤<asp:Literal ID="Literal1" runat="server"></asp:Literal></span>
                </td>
                <td class="right">
                </td>
            </tr>
        ...
        <table width="500" border="0" align="center" class="TableList no-top-border">
            ...
            <tr class="TableContent">
                <td valign="top" align="center">
                    <asp:ListBox ID="select1" runat="server" Height="220" Width="200" SelectionMode="Multiple">
                    </asp:ListBox>
                ...
                <td align="center" valign="top" bgcolor="#CCCCCC">
                    <asp:ListBox ID="select2" runat="server" Height="220" Width="200" SelectionMode="Multiple">
                    </asp:ListBox>
        ...
        <table width="500" border="0" align="center" class="TableList no-top-border">
            <tr class="TableContent">
                <td align="center">
                    点击条目时，可以组合CTRL或SHIFT键进行多选<a class="help" href="#">[?]</a>
                </td>
            </tr>
            <tr>
                <td align="center" class="TableFooter">
                    <asp:Button ID="Button1" runat="server" CssClass="BigButton" Text="保存" OnClientClick="mysubmit();"
