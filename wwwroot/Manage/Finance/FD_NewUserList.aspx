<%@ Page Title="" Language="C#" MasterPageFile="~/Manage/Master/MasterPage2.Master" AutoEventWireup="true" CodeBehind="FD_NewUserList.aspx.cs" Inherits="wwwroot.Manage.Finance.FD_NewUserList" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="text" runat="server">
    <uc1:MenuBar ID="MenuBar1" runat="server" Key="Finance_User" CurIndex="1" />
</asp:Content>
    ...
    <div id="PanelDefault">
        <asp:GridView ID="Gv_intojobs" runat="server" CssClass="table tableview" AllowPaging="True"
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="试用级别" SortExpression="Grade">
                    <ItemTemplate>
                        <%# Eval("GradeName","{0}") %><%# Eval("Grade","({0})") %>
                    </ItemTemplate>
                    <ItemStyle Width="120px" />
                </asp:TemplateField>
                <asp:TemplateField HeaderText="转正级别" SortExpression="Grade">
                    <ItemTemplate>
                        <%# Eval("PSalaryName", "{0}")%><%# Eval("PSalary", "({0})")%>
                    </ItemTemplate>
                    <ItemStyle Width="120px" />
                </asp:TemplateField>
                <asp:TemplateField HeaderText="保险" SortExpression="Grade">
                    <ItemTemplate>
