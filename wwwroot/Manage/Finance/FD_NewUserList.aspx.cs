...
{
    public partial class FD_NewUserList : System.Web.UI.Page
    {
        ...
        private void pageinit(string orderBy)
        {
            ...
            if (Request["mes"] != null)
            {
                WX.Main.MessageToHistory_where(String.Format("SendToUserId='{0}' and Title like'%FD_NewUserList.aspx%'", WX.Main.CurUser.UserID));
            }      
        }
