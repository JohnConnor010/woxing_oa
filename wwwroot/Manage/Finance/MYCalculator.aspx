<%@ Page Title="" Language="C#" MasterPageFile="~/Manage/Master/MasterPage2.Master"
    AutoEventWireup="true" CodeBehind="MYCalculator.aspx.cs" Inherits="wwwroot.Manage.Finance.MYCalculator" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="text" runat="server">
    <uc1:MenuBar ID="MenuBar1" runat="server" Key="Finance_MyDataList" CurIndex="2" />
</asp:Content>
