<%@ Page Title="" Language="C#" MasterPageFile="~/Manage/Master/MasterPage2.Master" AutoEventWireup="true" CodeBehind="NotifyCategory.aspx.cs" Inherits="wwwroot.Manage.XZ.NotifyCategory" %>
...
<uc1:MenuBar ID="MenuBar1" runat="server" Key="xz_notify" CurIndex="4" />
</asp:Content>
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder" runat="server">
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        DeleteCommand="DELETE FROM [XZ_NotifyCategory] WHERE [ID] = @ID" 
        InsertCommand="INSERT INTO [XZ_NotifyCategory] ([Name]) VALUES (@Name)" 
        SelectCommand="SELECT [ID], [Name] FROM [XZ_NotifyCategory]" 
        UpdateCommand="UPDATE [XZ_NotifyCategory] SET [Name] = @Name WHERE [ID] = @ID">
        <DeleteParameters>
