<%@ Page Title="" Language="C#" MasterPageFile="~/Manage/Master/MasterPage2.Master" AutoEventWireup="true" CodeBehind="MyReceiveFiles.aspx.cs" Inherits="wwwroot.Manage.XZ.MyReceiveFiles" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="text" runat="server">
    <uc1:MenuBar ID="MenuBar1" runat="server" Key="xz_notifyfiles" CurIndex="3" />
</asp:Content>
     ...
     <asp:GridView ID="GridView1" DataKeyNames="id" CssClass="table" runat="server" AutoGenerateColumns="False"
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="标题">
                <ItemTemplate>
                    <a style='<%# Eval("Istop").ToString()=="1"?"color:Red;font-weight:bold;":"color:Blue;" %>' href="javascript:PopupIFrame('Notifyfilesshow.aspx?NotifyFileId=<%# Eval("id") %>','文件详情','','',900,420)"><%# Eval("Title") %></a><%# Eval("Istop").ToString() == "1" ? "<img src='/images/arrow_up.gif' alt='置顶'/>" : ""%>
                </ItemTemplate>
            </asp:TemplateField>
            ...
            <asp:TemplateField ShowHeader="False" HeaderText="操作">
                <ItemTemplate>
                  <a href="javascript:PopupIFrame('Notifyfilesshow.aspx?NotifyFileId=<%# Eval("id") %>','文件审批','','',900,420)">查看</a>
                </ItemTemplate>
            </asp:TemplateField>
        </Columns>
    </asp:GridView>
