<%@ Page Title="" Language="C#" MasterPageFile="~/Manage/Master/MasterPage2.Master" AutoEventWireup="true" CodeBehind="MyCheckFiles.aspx.cs" Inherits="wwwroot.Manage.XZ.MyCheckFiles" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="text" runat="server">
    <uc1:MenuBar ID="MenuBar1" runat="server" Key="xz_notifyfiles" CurIndex="4" />
</asp:Content>
     ...
     <asp:GridView ID="GridView1" DataKeyNames="id" CssClass="table" runat="server" AutoGenerateColumns="False"
        ...
        <Columns>
            ...
            <asp:TemplateField ShowHeader="False" HeaderText="操作">
                <ItemTemplate>
                  <a href="javascript:PopupIFrame('NotifyFileDetail.aspx?NotifyFileId=<%# Eval("id") %>','文件审批','','',900,420)">审批</a>
                </ItemTemplate>
            </asp:TemplateField>
        </Columns>
    </asp:GridView>
