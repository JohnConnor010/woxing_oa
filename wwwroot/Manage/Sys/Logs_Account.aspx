<%@ Page Title="" Language="C#" MasterPageFile="~/Manage/Master/MasterPage2.Master" ClientIDMode="Static" EnableEventValidation="false"
    AutoEventWireup="true" CodeBehind="Logs_Account.aspx.cs" Inherits="wwwroot.Manage.Sys.Logs_Account" %>     
...
<uc1:MenuBar ID="MenuBar1" runat="server" Key="sysLogs" CurIndex="1" />
</asp:Content>
            ...
            <asp:Repeater ID="SupplierRepeater" runat='server'>
                <ItemTemplate>
                    <tr class="">
                        ...
                        <td>
                            <asp:Label runat="server" Text='<%# getIP(Eval("LogIP")) %>' />
                        </td>
                        <td>
                            <%#Eval("LogTime") %>
                        </td>
