<%@ Page Title="" Language="C#" MasterPageFile="~/Manage/Master/MasterPage2.Master" AutoEventWireup="true" CodeBehind="Duty_Edit.aspx.cs" Inherits="wwwroot.Manage.Sys.Duty_Edit" %>
...
<uc1:MenuBar ID="MenuBar1" runat="server" Key="duty-modi" CurIndex="2" Param1="{Q:companyID}" Param2="{Q:DutyId}" />
</asp:Content>
            ...
            <thead>
                <tr>
                    <td style="width: 160px;">
                        <a href="#" title='查看所有帮助' class="helpall">你正在编辑一个职务&nbsp;[?]</a>
                    </td>
                    <td>
                        &nbsp;
                        <asp:Button ID="btnSave" runat="server" Text="保存" OnClientClick="return Validator.Validate(this.form,3);"
