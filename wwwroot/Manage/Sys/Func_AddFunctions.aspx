<%@ Page Title="" Language="C#" MasterPageFile="~/Manage/Master/MasterPage2.Master"
    ClientIDMode="Static" EnableEventValidation="false" AutoEventWireup="true" CodeBehind="Func_AddFunctions.aspx.cs"
    Inherits="wwwroot.Manage.Sys.Func_AddFunctions" %>
...
<uc1:MenuBar ID="MenuBar1" runat="server" Key="func" CurIndex="2" />
</asp:Content>
    ...
    <div id="PanelManage">
        <table class="table">
            <thead>
                <tr>
                    <td colspan="2">
                        <a href="#" title='查看所有帮助' class="helpall">你正在添加一个功能&nbsp;[?]</a>
                    </td>
                </tr>
            </thead>
            <tr>
