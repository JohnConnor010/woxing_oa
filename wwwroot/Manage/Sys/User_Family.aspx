<%@ Page Title="" Language="C#" MasterPageFile="~/Manage/Master/MasterPage2.Master" ClientIDMode="Static" AutoEventWireup="true" CodeBehind="User_Family.aspx.cs" Inherits="wwwroot.Manage.Sys.User_Family" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="text" runat="server">
    <uc1:MenuBar ID="MenuBar1" runat="server"  Key="com_p" CurIndex="6" Param1="{Q:UserID}" Param2="{Q:companyid}" />
</asp:Content>
