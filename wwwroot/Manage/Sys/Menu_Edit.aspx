<%@ Page Title="" Language="C#" MasterPageFile="~/Manage/Master/MasterPage2.Master"  ClientIDMode="Static" EnableEventValidation="false" AutoEventWireup="true" CodeBehind="Menu_Edit.aspx.cs" Inherits="wwwroot.Manage.Sys.Menu_Edit" %>
...
<uc1:MenuBar ID="MenuBar1" runat="server" Key="menu-modi" CurIndex="2" Param1="{Q:MenuId}" />
</asp:Content>
    ...
    <div id="PanelManage">
        <table class="table">
            <thead>
                <tr>
                    <td colspan="2">
                        <a href="#" title='查看所有帮助' class="helpall">你正在修改一个菜单&nbsp;[?]</a>
                    </td>
                </tr>
            </thead>
            <tr>
            ...
            <tr id="tr1">
                ...
                <td>
                    <span class="note">菜单显示标题20个汉字以内</span> &nbsp;<input id="ui_Title" runat="server"
             ...
             <tr>
                ...
                <td>
                    <span class="note">菜单正序排序，数字小的排在前面</span> &nbsp;<input id="ui_OrderID" runat="server"
                        type="text" maxlength="20" style="width:20px" dataType="Number" require="false" />
                </td>
            </tr>
            <tr>
                <th style="width: 145px; font-weight: bold;">
                ...
                <td>
                    ...
                    <img runat="server" src="/Manage/icon/ico_home.gif" id="nowimg" alt="菜单图标" />
            ...
            <tr>
                ...
                <td>
                    ...
                    &nbsp;&nbsp;&nbsp;&nbsp;
                    <asp:Button ID="btnSave2" runat="server" CssClass="button" OnClientClick="return Validator.Validate(this.form,3);"
                        OnClick="btnSave2_Click" Text="加到全部职务" />
                    &nbsp;&nbsp;&nbsp;&nbsp;
                </td>
            </tr>
        </table>
