...
{
    public partial class Priv_Work : System.Web.UI.Page
    {
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            //7.返回处理结果或返回其它页面。
                ULCode.Debug.Alert(this, "工作经历修改成功！请完善下一步“员工证书”", "Priv_EditCredentials.aspx");
            }
            else
            {
                ULCode.Debug.Alert(Page, "工作经历修改失败！");
            }
        }
