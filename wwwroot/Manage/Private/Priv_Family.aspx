<%@ Page Title="" Language="C#" MasterPageFile="~/Manage/Master/MasterPage2.Master" AutoEventWireup="true" CodeBehind="Priv_Family.aspx.cs" Inherits="wwwroot.Manage.Sys.Priv_Family" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="text" runat="server">
    <uc1:MenuBar ID="MenuBar1" runat="server" Key="priv" CurIndex="4" />
</asp:Content>
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder" runat="server">
    ...
    <table class="table" runat="server" id="t3">
            <tr>
                <td>
                    <center>
                        <iframe height="400" frameborder="0" width="90%" src="../include/KeyXmlEdit.aspx?table=TU_Employees&column=Family&appid=Priv-Family&key=UserID&keyvalue=<%=WX.Main.CurUser.UserID %><%=WX.Main.CurUser.UserModel.ArchiveBySelf.ToBoolean()?"":"&ReadOnly=1" %>">
                        </iframe>
                    </center>
                </td>
            </tr>
        ...
        <table class="table" runat="server" id="t1">
            <tr>
                <th style="width: 135px; font-weight: bold;">
                    家庭成员&nbsp;<a href="#" class="help">[?]</a>
                </th>
                <td>
                    <span class="note">修改员工家庭成员。</span>
        ...
        <table class="table" runat="server" id="t2" visible="false">
            ...
            <tr>
                ...
                <td>
                    <asp:Button ID="Button1" runat="server" CssClass="button" Text="提交保存" OnClientClick="return confirm('如果提交，原来信息将被新模板代替，确认提交？')"
