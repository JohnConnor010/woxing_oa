<%@ Page Title="" Language="C#" MasterPageFile="~/Manage/Master/MasterPage2.Master" AutoEventWireup="true" CodeBehind="Priv_Work.aspx.cs" Inherits="wwwroot.Manage.Sys.Priv_Work" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="text" runat="server">
    <uc1:MenuBar ID="MenuBar1" runat="server" Key="priv" CurIndex="5" />
</asp:Content>
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder" runat="server">
    ...
    <table class="table" runat="server" id="t3">
            <tr>
                <td>
                    <center>
                        <iframe height="400" frameborder="0" width="90%" src="../include/KeyXmlEdit.aspx?table=TU_Employees&column=Work&appid=Priv-Work&key=UserID&keyvalue=<%=WX.Main.CurUser.UserID %><%=WX.Main.CurUser.UserModel.ArchiveBySelf.ToBoolean()?"":"&ReadOnly=1" %>">
                        </iframe>
                    </center>
                </td>
            </tr>
