<%@ Page Title="" Language="C#" MasterPageFile="~/Manage/Master/MasterPage2.Master"
    AutoEventWireup="true" CodeBehind="Priv_Logs.aspx.cs" Inherits="wwwroot.Manage.Sys.Priv_Logs" %>    
...
<uc1:MenuBar ID="MenuBar1" runat="server" Key="priv" CurIndex="9" />
</asp:Content>
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder" runat="server">
    <div style="padding-left: 20px; padding-right: 20px; color: #444">
        <div style="text-align: left; float: left; width: 700px;">
            请输入起始时间：&nbsp;&nbsp;开始时间：<asp:TextBox ID="txtBeginTime" class="easyui-datebox" runat="server" Width="100" BorderStyle="Solid"
                ...
                <ItemTemplate>
                    <tr class="">
                        <td style='<%#Eval("Title").ToString().Trim()=="登录OA系统"?"color: Green;":"color:Red;" %>'>
                               <img alt="" src="/Images/sign.gif" /> <%#Eval("Title") %>
                        </td>
                        <td>
