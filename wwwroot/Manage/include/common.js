...
$(function () {
    ...
    */
    //影藏字段说明
    if ($(".table td .note") != null) {
        $(".table td .note").hide();
    }
    if ($(".table1 td .note") != null) {
        $(".table1 td .note").hide();
    }
    //帮助字段提示
    if ($("a[class=help]") != null) {
...
function PrintSubPage(ContentId) {
    var PrintWin = window.open('/Manage/Finance/PrintPage.htm', 'Print');
    PrintWin.document.getElementById("bodystr").innerHTML = document.getElementById(ContentId).innerHTML;
