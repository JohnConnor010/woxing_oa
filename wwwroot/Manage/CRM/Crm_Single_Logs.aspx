<%@ Page Title="" Language="C#" MasterPageFile="~/Manage/Master/MasterPage2.Master" AutoEventWireup="true" CodeBehind="Crm_Single_Logs.aspx.cs" Inherits="wwwroot.Manage.CRM.Crm_Single_Logs" %>
...
<uc1:MenuBar ID="MenuBar1" runat="server" Key="MyCustomer" CurIndex="8" />
</asp:Content>
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder" runat="server">
<div style="text-align:left; padding-left:20px;">我的信息维护日志</div>
