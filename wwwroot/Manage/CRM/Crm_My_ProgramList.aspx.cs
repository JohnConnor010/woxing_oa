...
{
    public partial class Crm_My_ProgramList : System.Web.UI.Page
    {
        ...
        {
            string sql = "select ccp.*,cc.CustomerName,tu.RealName,ct.State TrackState from CRM_CustomerProgram ccp left join CRM_Customers cc on ccp.CustomerID=cc.ID left join TU_Users tu on ccp.UserID=tu.UserID left join CRM_Track ct on ccp.TrackID=ct.ID where cc.EmployeeID='" + WX.Main.CurUser.UserID + "'";
