<%@ Page Title="" Language="C#" MasterPageFile="~/Manage/Master/MasterPage2.Master" AutoEventWireup="true" CodeBehind="Crm_My_ProgramList.aspx.cs" Inherits="wwwroot.Manage.CRM.Crm_My_ProgramList" %>
...
<uc1:MenuBar ID="MenuBar1" runat="server" Key="MyCustomer" CurIndex="6" />
</asp:Content>
...
<asp:GridView ID="Gv_customer" runat="server" CssClass="table tableview" AllowPaging="True"
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="递送时间">
                <ItemTemplate>
                    <%#Convert.ToDateTime(Eval("ProgramTime")).ToString("yyyy-MM-dd HH:ss:mm")%>
                </ItemTemplate>
