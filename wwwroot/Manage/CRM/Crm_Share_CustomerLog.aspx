<%@ Page Title="" Language="C#" MasterPageFile="~/Manage/Master/MasterPage2.Master"
    AutoEventWireup="true" CodeBehind="Crm_Share_CustomerLog.aspx.cs" Inherits="wwwroot.Manage.CRM.Crm_Share_CustomerLog" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="text" runat="server">
    <uc1:MenuBar ID="MenuBar1" runat="server" Key="Customer-Share" CurIndex="2" />
</asp:Content>
