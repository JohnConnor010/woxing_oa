<%@ Page Title="" Language="C#" MasterPageFile="~/Manage/Master/MasterPage2.Master"
    AutoEventWireup="true" CodeBehind="Crm_Manage_CustomerList.aspx.cs" Inherits="wwwroot.Manage.CRM.Crm_Manage_CustomerList" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="text" runat="server">
    <uc1:MenuBar ID="MenuBar1" runat="server" Key="Customer" CurIndex="2" />
</asp:Content>
                ...
                <asp:Repeater ID="CustomerRepeater" runat="server">
                    <ItemTemplate>
                        <tr class='<%#String.Format("Stage{0}",ULCode.Bind.isNull(Eval("StageId"),"0",Convert.ToString(Eval("StageId"))))%>'>
                            ...
                            <td>
                            <a href='?userid=<%#Eval("EmployeeID")%>'><%#Eval("EmployeeUser")%></a>
                            ...
                            <td class="manage">
                                ...
                                <a class="show" href="Crm_Single_ShowCustomer.aspx?CustomerID=<%#Eval("ID") %>">信息维护</a>
                                <asp:LinkButton ID="btnDelete" runat="server" CommandArgument='<%#Eval("ID") %>'
                                    Text="废弃" OnClientClick="return confirm('确定要废弃此客户吗？')" OnCommand="btnDelete_Command"></asp:LinkButton>
                            </td>
                        </tr>
                    </ItemTemplate>
                </asp:Repeater>
