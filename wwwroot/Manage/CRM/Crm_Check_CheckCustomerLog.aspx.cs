...
{
    public partial class Crm_Check_CheckCustomerLog : System.Web.UI.Page
    {
        ...
        {
            string sql = "select * from CRM_Logs where LogType in(2,5,13) and UserID='" + WX.Main.CurUser.UserID + "'";
