//----------------------------------------------------------------------------
		...
		document.writeln('<iframe bgcolor="#000000" id=meizzDateLayer width="190px" height="247px" Author=wayx frameborder=0 style="position: absolute;z-index: 9998; display: none"></iframe>');
		strFrame='<style>';
		...
		function setday(tt,obj) //主调函数
		{
			...
			if(r!=null){
				...
				meizzSetDay(myDate.getFullYear(), myDate.getMonth()*1+1);
			}
			dads.display = '';
