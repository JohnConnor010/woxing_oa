var IMAGESPATH = '/js/zDialog/zDialog_images/';
...
Dialog.getBgdiv = function () {
    ...
    if (!bgdiv) {
        ...
        var bgIframeMask = '<div id="_DialogBGMask" style="position:absolute;background-color:#dedede;opacity:0.4;filter:alpha(opacity=40);width:100%;height:100%;"></div>';
...
function PopupIFrame(url, title,item1,item2, width, height) {
    var diag = new Dialog();
    diag.Width = width;
    diag.Height = height;
    diag.Title = title;
