...
{
    public partial class PRIV_DefaultLog : System.Web.UI.Page
    {
        //模块接口
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!this.IsPostBack)
            {
                ...
                this.Title = String.Format("{0:yyyy年MM月dd日}&nbsp;默认日志", this.ThisDate);
        ...
        {
            Response.Redirect(String.Format("PRIV_DefaultLog.aspx?Date={0:yyyy-MM-dd}", this.ThisDate.AddDays(1)));
        }
        ...
        {
            Response.Redirect(String.Format("PRIV_DefaultLog.aspx?Date={0:yyyy-MM-dd}", DateTime.Now));
        }
    }
}