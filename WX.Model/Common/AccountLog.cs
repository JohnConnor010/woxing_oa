...
namespace WX.Model
{
    ...
    public partial class AccountLog : XDataEntity
    {
        public AccountLog(string tableName)
            : base(tableName)
        {
        }
        public AccountLog(string tableName, string keyField)
            : base(tableName, keyField)
        {
        }
        public AccountLog(string cnName, string tableName, string keyField)
        ...
        {
            return new Log("TL_AccountLogs", "ID");
        }
