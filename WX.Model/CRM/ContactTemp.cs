...
namespace WX.CRM
{
    ...
    public partial class ContactTemp
    {
        //以下为实体开发部分
        //
    ...
    public partial class ContactTemp : XDataEntity
    {
        public ContactTemp(string tableName)
            : base(tableName)
        {
        }
        public ContactTemp(string tableName, string keyField)
            : base(tableName, keyField)
        {
        }
        public ContactTemp(string cnName, string tableName, string keyField)
            : base(cnName, tableName, keyField)
        {
        }
        //静态部分
        private static ContactTemp _entity;
        ...
        public static ContactTemp NewEntity()
        {
            return new ContactTemp("CRM_ContactTemp", "ID");
        }
        public static MODEL NewModel()
        {
            return new MODEL();
        }
        public static ContactTemp Entity
        {
            get
            {
                if (_entity == null)
        ...
        public partial class MODEL : XDataModel
        {
            ...
            public XDataField ContactID;
            public XDataField State;
            public XDataField CheckUserID;
            public XDataField CheckState;
            public XDataField Dept;
            public XDataField Duty;

            public MODEL() { }
            public MODEL(ContactTemp parentEntity) : base(parentEntity) { }
            public MODEL(ContactTemp parentEntity, DataRow drCache) : base(parentEntity, drCache) { }
            public MODEL(ContactTemp parentEntity, params object[] keyValues) : base(parentEntity, keyValues) { }
            public MODEL(ContactTemp parentEntity, DataTable dtCache, params object[] keyValues) : base(parentEntity, dtCache, keyValues) { }
            protected override void LoadFields()
            {
                ...
                this.ContactID = new XDataField("ContactID", DbType.Int32);
                this.State = new XDataField("State", DbType.Int32);
                this.CheckUserID = new XDataField("CheckUserID", DbType.String);
                this.CheckState = new XDataField("CheckState", DbType.Int32);
                ...
                base.AddFields(new XDataField[] { this.ID, this.CustomerID, this.ContactName, this.IsMain, this.Sex, this.Age
                    ...
                    , this.Remarks, this.ContactID, this.State, this.CheckUserID, this.CheckState,this.Dept,this.Duty });
            }
        }
    }
}
